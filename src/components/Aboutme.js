    ...
    <>
      <div className="back">
        <div className='divv'>
          ...
          <h1 className='hone'>I'm Rahul Shinde<br></br><p className='h5'>I'm into Mobile App (Flutter) development majorly and cloud</p></h1>
        </div>
        <div className="p1">
          <h1>About me</h1>
          <p className='p2'>
            ...
            I am into Mobile App (Flutter) development majorly and cloud (GCP and AWS).
          </p>
        </div>
      </div>
    </>
