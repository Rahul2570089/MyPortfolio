    ...
    <>
      <div className="back">
        <div className='divv'>
          ...
          <h1 className='hone'>I'm Rahul Shinde<br></br><p className='h5'>I'm into Mobile App development (Flutter) majorly and cloud </p><h6> <a href="https://medium.com/@rahul_226" target='_blank' rel='noreferrer'><button className='home-button'>Read my blogs</button></a></h6></h1>
        </div>
        <div className="p1">
          <h1>About me</h1>
          <p className='p2'>
