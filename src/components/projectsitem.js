...
const ProjectItem = (props) => {
    return (
        <div className='cardd d-flex justify-content-center my-5 col-xl-4' style={{height: '32rem', boxShadow: 'white'}}>
            <div className="card" style={{ width: '20rem' }}>
                <img className="card-img-top" src={props.photo} alt="..." style={{ height: '15rem', width: '19.9rem' }} />
                <div className="card-body">
                    <h5 style={{height: '2rem', color: 'white'}} className="card-title d-flex justify-content-center">{props.name}</h5>
