    ...
    <>
      <div className="container my-3">
        <div className="row d-flex justify-content-center">
          ...
          <ProjectItem photo={images['6.jpg']} name='NewsDeck' description='News app made in react including all types of news in India, fetched the data from free News API'></ProjectItem>
          <ProjectItem photo={images['7.jpg']} name='TextUtils' description='TextUtils App made in react used to perform basic operations on strings i.e convert to uppercase, lowercase, count number of words'></ProjectItem>
        </div>
      </div>
    </>
  )
